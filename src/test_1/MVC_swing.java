...
public class MVC_swing {
	public static void main(String[] args) {
		...
		// ControllerWindowOne controllerWindowOne = new
		// ControllerWindowOne(modelWardrobe, view);
		// // controllerWindowOne.startApp();
		//
		// ViewProductList viewProductList = new ViewProductList();
		// ControllerProductList controllerProductList = new
		// ControllerProductList(modelWardrobe, viewProductList);
		// // controllerProductList.startApp();
		//
		// ViewCurrentDay viewCurrentDay = new ViewCurrentDay();
		// ControllerCurrentDay controllerCurrentDay = new
		// ControllerCurrentDay(viewCurrentDay);
